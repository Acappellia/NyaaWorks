...
data modify storage nw:tmp cmd_to_update set value {floats:[]}
execute store result storage nw:tmp cmd_to_update.floats float 1 run data get storage nw:to_update fur[0].display_comp."minecraft:custom_data".display_comp."minecraft:custom_model_data"
