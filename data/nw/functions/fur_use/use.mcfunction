...
execute if score #fur_state nw matches 1 run data modify storage nw:tmp interaction_list set from entity @e[type=item_display,tag=nw_display,distance=..0.1,sort=nearest,limit=1] item.components."minecraft:custom_data".state_a.interaction
execute if score #fur_state nw matches 2 run data modify storage nw:tmp interaction_list set from entity @e[type=item_display,tag=nw_display,distance=..0.1,sort=nearest,limit=1] item.components."minecraft:custom_data".state_b.interaction
