...
execute store result score #display_translation nw run data get entity @s transformation.translation[0] 100
...
execute store result entity @s transformation.translation[0] float 0.01 run scoreboard players get #display_translation nw
