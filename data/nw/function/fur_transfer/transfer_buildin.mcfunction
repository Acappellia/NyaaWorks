...
execute store result storage nw:tmp fur_info.nw_fur_transfer_target_buildin int 1 run scoreboard players get @s fur_transfer_target_buildin
function nw:fur_transfer/clone_transfer_target_buildin with storage nw:tmp fur_info
...
scoreboard players operation @s fur_id_buildin = @s fur_transfer_target_buildin
