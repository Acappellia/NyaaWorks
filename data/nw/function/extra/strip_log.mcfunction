execute unless items entity @s weapon.mainhand #nw:logs_to_strip run return run tellraw @s [{"text": "[","color": "white"},{"text": "NyaaWorks","color": "#22aaff"},{"text": "]","color": "white"},{"text": " 手持原木进行去皮","color": "gray"}]
