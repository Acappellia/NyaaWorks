...
execute if score #player_pitch nw matches ..-45 run setblock ~ ~ ~ vine[up=true]
#execute if score #player_pitch nw matches ..-45 run data modify storage nw:tmp block_place.axis set value "y"
