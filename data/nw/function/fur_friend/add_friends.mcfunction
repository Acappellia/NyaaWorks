...
##check if self
execute if score @s p_id = #friend_id nw run tellraw @s [{"text": "[","color": "white"},{"text": "NyaaWorks","color": "#22aaff"},{"text": "] ","color": "white"},{"text": "无法与自己添加好友。如需添加好友请拆除家具后重新摆放。","color": "gray"}]
